...
namespace WatchKids.EndPoints.AuthAccount
{
    public static class ResetPasswordEndPoint
    {
        public static async Task<IResult> Handler(
            [FromBody] ResetPasswordRequest resetPasswordModel,
        ...
        )
        {
            try
            {
                ...
                var validationContext = new ValidationContext(resetPasswordModel);
                bool isValid = Validator.TryValidateObject(resetPasswordModel, validationContext, validationResults, true);
                ...
                var changePassResult = await userManager.ChangePasswordAsync(
                    user,
                    resetPasswordModel.CurrentPassword,
                ...
                if (!changePassResult.Succeeded)
                {
                    ...
                    return Results.BadRequest(Result<string>.Fail($"Error changing password: {errors}"));
                }

                return Results.Ok(Result<string>.Ok("Password changed successfully."));
            }
